...
public:
	...
	void addSeparatorLine(sf::Vector2f positionInContainer, sf::Vector2f dimensions, std::string name, tgui::Container::Ptr& container, tgui::Color color = {"Black"});

	void addSeparatorLine(sf::Vector2f positionInGUI, sf::Vector2f dimensions, std::string name, tgui::BackendGui& gui, tgui::Color color = { "Black" });
